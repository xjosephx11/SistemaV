    ...
    public partial class FrmCliente : Form
    {
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    respuesta = NPersona.Insertar("Cliente",txtNombre.Text.Trim(), cboTipoDocumento.Text, txtNumeroDocumento.Text.Trim(), txtDireccion.Text.Trim(), txtTelefono.Text.Trim(), txtEmail.Text.Trim());
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    respuesta = NPersona.Actualizar(Convert.ToInt32(txtId.Text),"Cliente",this.NombreAnt, txtNombre.Text.Trim(), cboTipoDocumento.Text, txtNumeroDocumento.Text.Trim(), txtDireccion.Text.Trim(), txtTelefono.Text.Trim(), txtEmail.Text.Trim());
                    if (respuesta.Equals("OK"))
                    {
